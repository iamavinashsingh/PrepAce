...
export async function createFeedback(params: CreateFeedbackParams) {
    ...
    // Transform categoryScores array to Record<string, number>
    const rawObject = object as {
        totalScore: number;
    ...
    const feedbackObject = {
        totalScore: rawObject.totalScore,
        categoryScores: Object.fromEntries(
            (rawObject.categoryScores || []).map(cat => [cat.name, cat.score])
        ),
        strengths: rawObject.strengths,
        areasForImprovement: rawObject.areasForImprovement,
        finalAssessment: rawObject.finalAssessment,
    };
